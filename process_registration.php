...
else if(!validateFirstNameSyntax($firstName)) exit("<strong>Invalid first name!</strong>");
else if(!validateLastNameSyntax($lastName)) exit("<strong>Invalid last name!</strong>");
